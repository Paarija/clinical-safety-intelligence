...
This project is designed for exploratory safety-signal triage. It should not be used for clinical decisions, prescribing guidance, regulatory submissions, or claims of causality.
