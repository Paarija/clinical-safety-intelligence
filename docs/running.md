...
Generated files live under `data/processed/` and are ignored by Git. For a clean demo run, use a fresh `DATA_DIR` or delete stale generated outputs before rerunning the pipeline.
