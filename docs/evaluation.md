...
These metrics are useful for regression checks and workflow review, but they do not prove clinical validity. Missed known positives may reflect quarter-specific reporting, low case counts, mapping gaps, or threshold choices. Highly ranked unexpected pairs require manual review rather than automatic dismissal or acceptance.
