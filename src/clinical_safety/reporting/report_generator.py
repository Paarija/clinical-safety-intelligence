...
_LIMITATION_BANNER = textwrap.dedent("""\
    ...
    > This report is an **exploratory research output** for analyst review only.
    ...
    > This system is NOT a clinical decision support tool, drug withdrawal engine,
    > or regulatory-grade pharmacovigilance system. Do NOT use this report for
    > clinical decisions, prescribing guidance, or regulatory submissions without
...
class ReportGenerator:
    ...
    def _render_header(packet: EvidencePacket) -> str:
        return (
            ...
            f"**System:** Clinical Safety Intelligence v0.1 (Research / Demo Only)"
        )
