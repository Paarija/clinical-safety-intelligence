...
Clinical Safety Intelligence is a Python project for exploring drug safety signals in public pharmacovigilance data. It focuses on GLP-1 receptor agonists and gastrointestinal adverse-event families, then combines FAERS signal detection with trial, regulatory, and literature evidence.
...
- Interview-friendly outputs: Streamlit dashboard, Markdown reports, benchmark snapshot, and documented limitations.
...
This project is an exploratory research and portfolio project. It is not a clinical decision support tool, drug withdrawal engine, or regulatory-grade pharmacovigilance system.
